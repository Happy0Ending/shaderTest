import { ArcRotateCamera, Color3, Color4, Engine, GlowLayer, HemisphericLight, MeshBuilder, PostProcess, Scene, Vector3 } from "babylonjs";
import { AdvancedDynamicTexture, ColorPicker, Rectangle, Slider, TextBlock } from "babylonjs-gui";
import { gradientMat } from "../shader";

export function wireFrameScene(engine: Engine, canvas: HTMLCanvasElement) {
